...
HD_PWD='C:/sscproiect/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ethernet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_ethernet.tcl
