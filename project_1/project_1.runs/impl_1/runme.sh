...
HD_PWD='C:/sscproiect/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ethernet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_ethernet.tcl -notrace
