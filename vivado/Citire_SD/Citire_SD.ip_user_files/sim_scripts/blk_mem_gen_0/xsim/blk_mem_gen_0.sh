...
#
# Script generated by Vivado on Wed Nov 19 12:16:53 +0200 2025
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c60d.protoinst" -protoinst "protoinst_files/design_citireSD.protoinst" -log simulate.log
}
