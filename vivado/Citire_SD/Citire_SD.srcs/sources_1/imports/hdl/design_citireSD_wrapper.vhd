...
--Date        : Wed Nov 19 13:21:24 2025
--Host        : Laptop_Adi running 64-bit major release  (build 9200)
--Command     : generate_target design_citireSD_wrapper.bd
--Design      : design_citireSD_wrapper
...
entity design_citireSD_wrapper is
  port (
...
end design_citireSD_wrapper;

architecture STRUCTURE of design_citireSD_wrapper is
  component design_citireSD is
  port (
    BRAM_PORTA_0_addr : out STD_LOGIC_VECTOR ( 12 downto 0 );
    BRAM_PORTA_0_clk : out STD_LOGIC;
    BRAM_PORTA_0_din : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component design_citireSD;
begin
design_citireSD_i: component design_citireSD
     port map (
