...
HD_PWD='C:/ssc/PROIECT/vivado/Citire_SD/Citire_SD.runs/design_citireSD_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_citireSD_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_citireSD_axi_gpio_0_0.tcl
